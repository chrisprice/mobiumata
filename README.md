...
![Flow diagram showing the controller connected to LED0, which connects to LED1, which connects to ..., which connects to LEDN](docs/led-protocol.jpg)
...
![Animating a simple pattern across a flexible circuit board](docs/flexible-animation.gif)
...
![Mobius strip made out of paper](docs/mobius-strip.jpg)
...
[![One dimension cellular automata rule 30 explainer](docs/rule-30.gif)](https://en.wikipedia.org/wiki/File:One-d-cellular-automate-rule-30.gif)
...
![Bending aluminium strip using a piece of scaffold tube, clamps and a big hammer](docs/bending-metal.jpg)

It took a little while but I was very happy with the result. It almost felt a shame to cover it up with LEDs!

![One dimension cellular automata rule 30 explainer](docs/naked-mobiumata.jpg)
...
![The display hardware complete](docs/display-hardware-complete.jpg)
...
![CNC cutting holes for control box switches](docs/control-box-holes.gif)
...
![CNC engraving tool crashes into control box](docs/control-box-engraving.gif)
...
![Initial animation speed](docs/initial-animation.gif)
...
![One strand left](docs/one-strand-left.jpg)
